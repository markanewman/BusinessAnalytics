...
Objective function
```{r}
obj = c(.60, .56, .22, .40, .36, .3, .28, .58, .65, .68, .55, .42)
names(obj) = dv
```
...
model = lpSolve::lp ("min", obj, lhs, dir, rhs)
model$objval
model$solution
...
This matches our result `$Solution` MA=0,MB=0,MC=9000,MD=0,PA=3500,PB=8500,PC=0,PD=0,TA=4000,TB=0,TC=499.999999999999,TD=8000 yealds 12025

* Remove 0s: MC=9000, PA=3500, PB=8500, TA=4000, TC=499.999999999999, TD=8000 yealds 12025
* Round: MC=9000, PA=3500, PB=8500, TA=4000, TC=500, TD=8000 yealds 12025
