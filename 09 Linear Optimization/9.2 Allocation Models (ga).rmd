...
The intent of this extended example is to look at how to solve a clasic lp formulation using a genetic solver to see how the different R packages work. 
